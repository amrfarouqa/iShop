        ...
        <div id="wrapper">
            ...
            <section id="main-content" class="clearfix">
            	<aside id="my-account-menu">
                    ...
                    <ul>
                        <li><a href="cust-personal-details.php">My Account</a></li>
                        <b><li><a href="cust-wishlist.php">Wishlist</a></li></b>
                        <li><a href="cust-order-history.php">Order History</a></li>
                        <li><a href="logout.php">Sign Out</a></li>
                    </ul>
			...
			<h3>My Wishlist</h3>
                <h1 align="center"><?php echo $error; ?></h1>
            ...
            $sql="SELECT  `prodname` as ProductName, `imglink` as IMAGE, `unitprice` as UnitPrice, `quantity` as Quantity, `subtotal` as Subtotal FROM `wishlist` WHERE  `memberid`=((SELECT `memberid` FROM `members` WHERE `firstname`='$usernameview'))";
			...
			<form method="POST" align="center">
					<input type="submit" name="deleteall" value="DELETE ALL" class="secondary-cart-btn">
