...
<html class="no-js">
    <head>
        ...
        <meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1">
         <title>iShop - Administrator</title>
                    ...
                    <!--<nav class="dropdown">
                        <ul>
                            <li>
                                ...
                                <ul>
                                    <li><a href="admin-mac-category.php">Mac</a></li>
                                    <li><a href="admin-iphone-category.php">iPhone</a></li>
                                    <li><a href="admin-ipad-category.php">iPad</a></li>
                                </ul>
                            </li>
                        </ul>
                    </nav>
                    ...
                    <div id="user-menu">
                       ...
                       <!--
                        <nav id="signin" class="dropdown">
                            <ul>
                                <li>
                                    <a href="#"><img src="img/user-icon.gif" alt="Sign In" /> Account <img src="img/down-arrow.gif" alt="Sign In" /></a>
                                    <ul>
                        ...
                        <nav class="dropdown">
                            <ul>
                                <li>
                                    <a href="admin.php"><img src="img/user-icon.gif" alt="" /><?php echo $usernametype;?><img src="img/down-arrow.gif" alt="" /></a>
                                    <ul>
